...
export default function AlternativesStep({
  ...
  return (
    <SignupStepLayout stepKey="alternatives" progressPercent={progressPercent}>
          ...
          <div className="space-y-6">
            ...
            <div className="animate-fade-slide-in step-delay-4 bg-surface-subtle rounded-lg p-5 space-y-3">
              ...
              <p className="font-mono text-sm text-foreground leading-relaxed">
                <span className="text-primary">Excel spreadsheets</span>,{' '}
                <span className="text-primary">Email threads</span>,{' '}
                <span className="text-primary">Pen and paper</span>
              </p>
            </div>
          </div>
